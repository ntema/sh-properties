...
const getAllMessages = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let option = {};
        console.log(option);
        const count = yield models_1.Message.find(option).countDocuments();
        ...
        const messages = yield models_1.Message.find(option)
            .populate("from")
            .populate("to")
            .populate("property")
            .limit(limit * 1)
        ...
        return res
            .status(200)
            .json({ status: "success", data: Object.assign(Object.assign({}, result), { count, pages, messages }) });
    }
    catch (error) {
        next(error);
    }
