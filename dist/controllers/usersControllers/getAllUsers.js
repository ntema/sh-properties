...
const getAllUsers = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let option = {};
        console.log(option);
        const count = yield models_1.User.find(option).countDocuments();
        ...
        const users = yield models_1.User.find(option)
            .limit(limit * 1)
            .skip(skip);
        return res
            .status(200)
            .json({ status: "success", data: Object.assign(Object.assign({}, result), { count, pages, users }) });
    }
    catch (error) {
        next(error);
    }
