...
exports.getBookingsByLoggedUser = void 0;
const models_1 = require("../../models");
const getBookingsByLoggedUser = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let { limit = 20, page = 1 } = req.query;
        page = page || 1;
        const skip = page ? (page - 1) * limit : 0;
        //@ts-ignore
        let option = { bookee: req.user._id };
...
exports.getBookingsByLoggedUser = getBookingsByLoggedUser;
